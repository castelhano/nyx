...
5. [ x ] Visão de mapa plotar todos os sentidos, apenas o selecionado editavel
...
8. [ x ] Adicionar no settings de transit variavel propagateExtensionToOfficialKm (default=true), se true, ao persistir alteração em rota isPrimary altera TransitLine.metrics.extensionKm (no sentido equivalente) a extsão ajustada

...
const LOCALITIES: Array<{
  ...
  { code: '1030', name: 'Vila Jardim',      abbr: 'V JARD', lat: -15.560505650799800, lng: -56.120473766906400  },
...
function biWindows(cycleMin: number) {
...
const LINES: Array<{ code: string; name: string; type: string; metrics?: object }> = [
  { code: '31',   name: 'Corujao Cpa 4 x Centro',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 13.1,    INBOUND: 13.1    }, windows: biWindows(40)  } },
  { code: '32',   name: 'Jd Vitoria x Coopamil',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 13.85,   INBOUND: 13.85   }, windows: biWindows(40)  } },
  { code: '33',   name: 'Jd Vitoria x Pq Cuiaba',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 33.2,    INBOUND: 33.2    }, windows: biWindows(40)  } },
  { code: '34',   name: 'Jd Vitoria x Pedra 90',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 38.85,   INBOUND: 38.85   }, windows: biWindows(40)  } },
  { code: '105',  name: 'Santa Marta x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 12.95,   INBOUND: 12.95   }, windows: biWindows(200) } },
  { code: '107',  name: 'Santa Amalia x T Cpa I',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 38,      INBOUND: 38      }, windows: biWindows(288) } },
  { code: '203',  name: 'Vale Dos Lirios x Centro',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 18.25,   INBOUND: 18.25   }, windows: biWindows(110) } },
  { code: '204',  name: 'B Da Chapada x Centro',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 9.995,   INBOUND: 9.995   }, windows: biWindows(80)  } },
  { code: '205',  name: 'Respaiaguas x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 11.9,    INBOUND: 11.9    }, windows: biWindows(84)  } },
  { code: '206',  name: 'Cpa1 x Centro',                   type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 16.5,    INBOUND: 16.5    }, windows: biWindows(126) } },
  { code: '213',  name: 'Tres Poderes x Centro',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 14.05,   INBOUND: 14.05   }, windows: biWindows(96)  } },
  { code: '225',  name: 'Altos Da Boa Vista x Centro',     type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 7.955,   INBOUND: 7.955   }, windows: biWindows(64)  } },
  { code: '250',  name: 'T Antartica x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 10.85,   INBOUND: 10.85   }, windows: biWindows(84)  } },
  { code: '251',  name: 'Pronto Socorro x Alencastro',     type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 6.75,    INBOUND: 6.75    }, windows: biWindows(66)  } },
  { code: '301',  name: 'Jd Vitoria x Centro',             type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 11.3,    INBOUND: 11.3    }, windows: biWindows(99)  } },
  { code: '302',  name: 'Vila Da Serra x Centro',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 15.95,   INBOUND: 15.95   }, windows: biWindows(132) } },
  { code: '306',  name: 'Term Cpa 3 x G Terceiro',         type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 12.2,    INBOUND: 12.2    }, windows: biWindows(90)  } },
  { code: '308',  name: 'Term Cpa 3 x Rib Do Lipa',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 21.73,   INBOUND: 21.73   }, windows: biWindows(320) } },
  { code: '309',  name: '1o De Marco x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 21.6,    INBOUND: 21.6    }, windows: biWindows(144) } },
  { code: '310',  name: 'Term Cpa Iii x Centro',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 9.64,    INBOUND: 9.64    }, windows: biWindows(75)  } },
  { code: '311',  name: 'N Mato Grosso x Centro',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 13.9,    INBOUND: 13.9    }, windows: biWindows(130) } },
  { code: '313',  name: 'Term Cpa 3 x Fiemtec',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 15.55,   INBOUND: 15.55   }, windows: biWindows(132) } },
  { code: '319',  name: 'Tres Barras x Porto',             type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 16.995,  INBOUND: 16.995  }, windows: biWindows(165) } },
  { code: '323',  name: 'Ter Cpa I x Crd Aquino',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 16.4,    INBOUND: 16.4    }, windows: biWindows(176) } },
  { code: '330',  name: 'Ter Cpa I x Ufmt',                type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 13.115,  INBOUND: 13.115  }, windows: biWindows(95)  } },
  { code: '340',  name: 'A Da Gloria x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 15.25,   INBOUND: 15.25   }, windows: biWindows(130) } },
  { code: '380',  name: 'Term Cpa 1 x Estacao Shopp',      type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 17.2,    INBOUND: 17.2    }, windows: biWindows(88)  } },
  { code: '390',  name: 'Res Picolli x Centro',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 16.75,   INBOUND: 16.75   }, windows: biWindows(88)  } },
  { code: '409',  name: 'Praeiro x Centro',                type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 6.55,    INBOUND: 6.55    }, windows: biWindows(66)  } },
  { code: '410',  name: 'Sta Rosa x Gde Terceiro',         type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 10.46,   INBOUND: 10.46   }, windows: biWindows(99)  } },
  { code: '721',  name: 'Volunt Patria x Shopp Pantanal',  type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 24.6585, INBOUND: 24.6585 }, windows: biWindows(140) } },
  { code: '800',  name: 'Dist Da Guia x Centro',           type: 'RURAL',   metrics: { extensionKm: { OUTBOUND: 37.8,    INBOUND: 37.8    }, windows: biWindows(150) } },
  { code: '206B', name: 'Florianopolis x Centro',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 11.65,   INBOUND: 11.65   }, windows: biWindows(54)  } },
  { code: '308B', name: 'Term Cpa 3 x Alencastro',         type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 10.41,   INBOUND: 10.41   }, windows: biWindows(80)  } },
  { code: '309B', name: 'Term Cpa 3 x Centro',             type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 10.9,    INBOUND: 10.9    }, windows: biWindows(65)  } },
  { code: '311B', name: 'N Mato Grosso (v Alice Freire)',  type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 14.6,    INBOUND: 14.6    }, windows: biWindows(130) } },
  { code: 'A02',  name: 'Alim Cpa 1 x B Branco',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 8.576,   INBOUND: 8.576   }, windows: biWindows(56)  } },
  { code: 'A06',  name: 'Alim Cpa 1 x Gamaliel',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 14.3,    INBOUND: 14.3    }, windows: biWindows(95)  } },
  { code: 'A06B', name: 'Alim Cpa 1 x A Da Gloria',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 7.3,     INBOUND: 7.3     }, windows: biWindows(60)  } },
  { code: 'A07',  name: 'Alim Cpa 1 x S Dourada',          type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 7.8,     INBOUND: 7.8     }, windows: biWindows(90)  } },
  { code: 'A08',  name: 'Alim Cpa 1 x 1o De Marco',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 8.4,     INBOUND: 8.4     }, windows: biWindows(60)  } },
  { code: 'A10',  name: 'Alim Cpa 1 x Setor 3 E 4',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 5.65,    INBOUND: 5.65    }, windows: biWindows(72)  } },
  { code: 'A14',  name: 'Alim Cpa 3 x Dr Fabio',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 4.9,     INBOUND: 4.9     }, windows: biWindows(60)  } },
  { code: 'A15',  name: 'Alim Cpa 3 x A Da Serra',         type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 3.15,    INBOUND: 3.15    }, windows: biWindows(36)  } },
  { code: 'A16',  name: 'Alim Cpa 3 x 1o De Marco',        type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 8.34,    INBOUND: 8.34    }, windows: biWindows(50)  } },
  { code: 'A17',  name: 'Alim Cpa 3 x Planalto',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 3.06,    INBOUND: 3.06    }, windows: biWindows(38)  } },
  { code: 'A20',  name: 'Alim Cpa 1 x Vila Da Serra',      type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 4.905,   INBOUND: 4.905   }, windows: biWindows(50)  } },
  { code: 'A22',  name: 'Alim Ambev x Bandeira',           type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 11.7,    INBOUND: 11.7    }, windows: biWindows(60)  } },
  { code: 'A22B', name: 'Sucuri x Vila Jardim',            type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 7.255,   INBOUND: 7.255   }, windows: biWindows(47)  } },
  { code: 'A22C', name: 'Alim Ambev x Sucuri',             type: 'URBAN',   metrics: { extensionKm: { OUTBOUND: 5.54,    INBOUND: 5.54    }, windows: biWindows(38)  } },
  { code: 'C01',  name: 'Universitaria',                   type: 'SPECIAL', metrics: { extensionKm: { OUTBOUND: 12.4,    INBOUND: 12.4    }, windows: biWindows(99)  } },
  { code: 'C02',  name: 'Circ Florais Italia x Av Trab',   type: 'SPECIAL', metrics: { extensionKm: { OUTBOUND: 8.17,    INBOUND: 8.17    }, windows: biWindows(50)  } },
  { code: 'R01',  name: 'Term Cpa 3 x Coxipo Do Ouro',     type: 'RURAL',   metrics: { extensionKm: { OUTBOUND: 20.15,   INBOUND: 20.15   }, windows: biWindows(113) } },
...
const ROUTES: RouteSeed[] = [
  ...
  { lineCode: 'A22C', direction: 'OUTBOUND', name: 'SUCURI - V JARD', originCode: '1000', destinationCode: '1029' },
  { lineCode: 'A22C', direction: 'INBOUND',  name: 'V JARD - SUCURI', originCode: '1029', destinationCode: '1000' },

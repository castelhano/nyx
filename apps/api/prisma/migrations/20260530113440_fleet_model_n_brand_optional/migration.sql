...
INSERT INTO "new_vehicles" ("acquisitionDate", "acquisitionValue", "branchId", "brandId", "chassis", "code", "color", "createdAt", "fuelType", "id", "modelId", "modelYear", "notes", "odometer", "plate", "renavam", "seatedCapacity", "status", "totalCapacity", "transmission", "updatedAt", "vehicleType", "year") SELECT "acquisitionDate", "acquisitionValue", "branchId", "brandId", "chassis", "code", "color", "createdAt", "fuelType", "id", "modelId", "modelYear", "notes", "odometer", "plate", "renavam", "seatedCapacity", "status", "totalCapacity", "transmission", "updatedAt", "vehicleType", "year" FROM "vehicles";
DROP TABLE "vehicles";

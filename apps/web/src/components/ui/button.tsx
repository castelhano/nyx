...
type Variant = 'default' | 'safeConfirm' |'destructive' | 'outline' | 'ghost' | 'rowAction' | 'cancel'
type Size    = 'sm' | 'default' | 'lg' | 'icon'

const variants: Record<Variant, string> = {
  default:     'bg-accent hover:bg-accent/80 text-accent-foreground',
  ...
  cancel:      'bg-mist-400/80 hover:bg-mist-400 dark:bg-mist-700 dark:hover:bg-mist-600',
